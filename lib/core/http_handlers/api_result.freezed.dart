...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(NetworkExceptions error, int statusCode, T? data)
        failure,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(NetworkExceptions error, int statusCode, T? data)?
        failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>({
    TResult Function(T data)? success,
    TResult Function(NetworkExceptions error, int statusCode, T? data)? failure,
...
abstract class _$$FailureImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({NetworkExceptions error, int statusCode, T? data});
...
class _$FailureImpl<T> implements Failure<T> {
  const _$FailureImpl(
      {required this.error, required this.statusCode, this.data});
  ...
  @override
  String toString() {
    return 'ApiResult<$T>.failure(error: $error, statusCode: $statusCode, data: $data)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return failure(error, statusCode, data);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return failure?.call(error, statusCode, data);
  }
