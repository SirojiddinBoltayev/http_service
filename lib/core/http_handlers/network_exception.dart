...
// import '../../presantation/global_widgets/route_widgets.dart';
// import '../../router/routes.dart';
// import '../storage/get_storage/local_storage.dart';

// import '../get_storage/local_storage.dart';
...
class NetworkExceptions with _$NetworkExceptions {
          ...
          switch (error.type) {
            ...
            case DioExceptionType.badResponse:
              switch (error.response!.statusCode) {
                ...
                // AppNavigator.pushAndPopUntil(const AuthRoute());
  ...
  static String messageConverter(dynamic data) {
